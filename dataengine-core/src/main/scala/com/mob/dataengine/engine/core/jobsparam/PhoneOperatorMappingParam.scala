...
class PhoneOperatorMappingInput(override val uuid: String, override val idType: Int = 3,
...
class PhoneOperatorMappingOutput(override val uuid: String, override val hdfsOutput: String)
...
class PhoneOperatorMappingParam(override val inputs: Seq[PhoneOperatorMappingInput],
                                   override val output: PhoneOperatorMappingOutput)
