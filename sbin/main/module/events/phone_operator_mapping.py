...
from module.tools import utils, shell
...
class PhoneOperatorMapping(RpcJob):
    ...
    def run(self):
        self.spark2.submit(
            ...
            props={
                "--class": main_class.PHONE_OPERATOR_MAPPING,
                "--driver-memory": "8g",
                "--executor-memory": "9g",
                "--executor-cores": "3",
                "--num-executors": "5"
...
class PidOperatorMapping(RpcJob):
    def __init__(self, job):
        RpcJob.__init__(self, job)
        self.target_hive_table = prop_utils.HIVE_TABLE_DATA_OPT_CACHE_NEW
    ...
    def run(self):
        self.spark2.submit(
            ...
            job_name=self.job_name, job_id=self.job_id,
            props={
                "--class": main_class.PID_OPERATOR_MAPPING,
                "--driver-memory": "8g",
                "--executor-memory": "9g",
                "--executor-cores": "3",
                "--num-executors": "5"
